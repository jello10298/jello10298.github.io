...
const Tile = ({name, image, waybackLink}) => {
    return (
        <span>
                            <h4>{name}</h4>
        ...
        <div>
            ...
            <ul style={{position: 'static'}}>
                <li>
                    ...
                    <p>
                        As a Full Stack AEM Consultant at Hyatt, I oversaw the development of a comprehensive system
                        from scratch, reimagining and implementing over 1,600 websites across 20 brands and 10
                        languages. This involved designing templates, migrating data from a legacy AEM system, and
                        orchestrating frontend and backend development which lead to Atlas, a GraphQL API integrated
                        into over 20 teams, streamlining data access for property-specific information. I spearheaded
                        the migration of the frontend to React/NextJS, enhancing user experience and significantly
                ...
                <li>
                    ...
                    <p>
                        • Managed, maintained and performance optimized legacy healthcare related software during
                        ...
                        framework.<br />
                        • Maintained and updated Selenium end-to-end automated tests with 100% code coverage.<br />
                        • Participated in the rollout of Github Actions to replace Jenkins pipelines for continuous
                ...
                <li>
                    ...
                    <p>
                        • Implemented API for remote xbox game installation from product pages on microsoft.com<br />
                        • Combined AEM SSI (server-side includes) with React SSR (server-side rendering) for efficient Publisher caching and page loading optimization strategies.<br />
                        • Implemented Buy Box for wishlist, SKU selector and color picker functionality for Microsoft Store physical and virtual goods.<br />
                        • Instructed new members on efficient AEM, React and frontend development practices.<br />
                    </p>
            ...
            <li>
                ...
                <p>
                    • Frontend Developer Consultant brought onboard to help close several projects for Valtech’s Chicago office.<br />
                    • Lead frontend developer for Adobe Experience Manager (AEM) based meetings and events site for Hyatt (http://meetings.hyatt.com).<br />
                    • Lead frontend developer for Groovy based service quote submission site for Rolex.<br />
                    • Lead front end developer for AEM based Digital Assets Management (DAM) repository file upload tool created for Lundbeck.<br />
                </p>
            ...
            <li>
                <a href={'https://agorawebsolutions.com/'} target={'_blank'}>04/05-07/10 Agora Web Solutions,
                    Inc.</a><br/>
                <p>
                    Created over 300 websites and delivered over 100 open source web solutions to over 80 clients.
                    <br/>
                    1 employee ever - Paul Monson<br/>
                    <a href={'https://www.linkedin.com/in/paul-monson-16aa451a/'} target={'_blank'}>Original LinkedIn
                        Page</a><br/>
                ...
                <Tile name={"University of Connecticut - Domino's"} image={'/portfolio/dominos/2.uconn.jpg'}/>
            ...
            <li>
                <a href={'https://www.discover.com/'} target={'_blank'}>06/01-04/05 Morgan Stanley – Discover
            ...
            <li>
                <a href={'https://www.embs.org/'} target={'_blank'}>11/00-03/01 Rehabilitation Institute of
                    Chicago</a>
                <Tile name={"IEEE Engineering in Medical and Biological Society"} image={'/portfolio/IEEE - EMBS.png'}/>
            </li>
            <li>
                <a href={'https://www.icair.org/'} target={'_blank'}>06/00-08/01 iCAIR – International Center
