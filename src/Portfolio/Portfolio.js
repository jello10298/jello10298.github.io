            ...
            <div>
                ...
                <ul style={{position: 'static'}}>
                    <li>
                        ...
                        <Tile name={"Grand Hyatt"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Hyatt Regency"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Hyatt"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Hyatt Vacation Club"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Hyatt Place"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Hyatt House"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Hyatt Studios"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"UrCove"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>

                        <h3>Boundless Collection</h3>
                        <Tile name={"Miraval"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Alila"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Andaz"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                        <Tile name={"Thompson"} image={'/portfolio/Hyatt/Logos/Hyatt.png'}/>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            <a href={'https://www.linkedin.com/in/paul-monson-16aa451a/'} target={'_blank'}>Original LinkedIn Page</a><br />
